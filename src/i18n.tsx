...
const en = {
  ...
  'settings.processRulesDesc': 'Rules link apps to categories. Use them to get a banner when an unclassified app is open. Note: rules do not start the timer automatically — you still control when tracking begins.',
  ...
  'settings.modeAutoDesc': 'shows a banner to start the timer when this app is open',
  'settings.modeSuggestDesc': 'silently classifies the window without prompting',
...
const pt: { [K in keyof typeof en]: string } = {
  ...
  'settings.processRulesDesc': 'Regras vinculam apps a categorias. Quando um app não classificado estiver aberto, aparecerá um banner. Atenção: as regras não iniciam o timer automaticamente — você controla quando o rastreamento começa.',
  'settings.processRulesEmpty': 'Sem regras ainda — abra um app com o timer ativo e classifique-o pelo banner na aba Rastreador.',
  'settings.modeAutoDesc': 'exibe um banner para iniciar o timer quando este app estiver aberto',
  'settings.modeSuggestDesc': 'classifica a janela silenciosamente sem notificação',
